...
# ADD LINK32 LIBCTINY.LIB MSVCRT.LIB KERNEL32.LIB /nologo /subsystem:console /machine:I386 /MERGE:.rdata=.data /MERGE:.text=.data /MERGE:.reloc=.data /FILEALIGN:0x200 /IGNORE:4078 /IGNORE:4089
