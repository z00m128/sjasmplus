...
# "remote curl build" bash script to build latest stable release v1.15.0
...
echo "# Downloading + extracing sjasmplus sources (stable release v1.15.0) from github..."
curl -O -L https://github.com/z00m128/sjasmplus/archive/v1.15.0.tar.gz && \
tar xf v*.tar.gz && \
cd sjasmplus*
SRC_RESULT=$?
