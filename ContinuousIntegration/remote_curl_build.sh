...
# "remote curl build" bash script to build latest stable release v1.18.2
...
echo "# Downloading + extracing sjasmplus sources (stable release v1.18.2) from github..."
curl -O -L https://github.com/z00m128/sjasmplus/archive/v1.18.2.tar.gz && \
tar xf v*.tar.gz && \
cd sjasmplus*
SRC_RESULT=$?
