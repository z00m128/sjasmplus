    ...
    ; (some will emit damaged machine code of legit LR35902 instruction, like LD bc,ix)

    ORG 0x8000
    ; VALID LR35902 instructions (not fake!)
ldi_#hl#_a          ldi (hl),a      ; #22
ldi_a_#hl#          ldi a,(hl)      ; #2A
ldd_#hl#_a          ldd (hl),a      ; #32
ldd_a_#hl#          ldd a,(hl)      ; #3A

    ; Z80 fake instructions
rl_bc               rl bc
rl_de               rl de
rl_hl               rl hl
rr_bc               rr bc
...
zxn_mul             mul         ; no warning "correct" syntax: "mul d,e" and "mul de"
    ; these definitely should not work in LR35902 mode (trying to switch --zxnext is fatal error)
